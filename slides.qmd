...
![](img/stats19_form.png){.absolute top="50" left="20" width="42%"} ![](img/stats19_2.png){.absolute top="80" left="600" width="35%"}
...
::: notes
Three linked tables: Accidents/Collisions, Casualties, and Vehicles.
Provides a wide set of possibilities for spatial and transport safety analysis.
:::
...
![](img/denom_1.png){.absolute top="50" left="30" width="60%"} ![](img/trends.png){.absolute top="20" left="500" width="40%" style="transform: rotate(15deg);"}
...
::: notes
Crashes occur as a result of interacting conditioning context.
Once you start decomposing statistical summaries, separating relative effects is challenging.
:::

------------------------------------------------------------------------

![](img/analysis1.png){.absolute top="80" left="450" width="48%"} ![](img/analysis2.png){.absolute top="350" left="450" width="44%"} ![](img/ga_twitter.png){.absolute top="10" left="10" width="30%"}
...
## The importance of geographic aggregation
...
-   **Roger's slides**: [rogerbeecham.com](https://www.roger-beecham.com/slides/cars_crime) and code [github.com/rogerbeecham/slides](https://github.com/rogerbeecham/slides)
