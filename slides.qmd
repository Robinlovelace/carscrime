...
## Part 2: Tools in Action — criticalissues

A complementary tool for exploring road safety data at high spatial resolution:

![criticalissues.netlify.app — WYCA region with SA01 (signal) layer](images/criticalissues-demo.png)

- **Critical Issues** ([criticalissues.netlify.app](https://criticalissues.netlify.app)) combines STATS19 crash data with network infrastructure to identify locations needing intervention.
- Explore how spatial layers (signals, crossings, widths) relate to casualty clusters.
- Discuss where the STATS19 *classification* matched your *intuition*.
...
- **Cars and Crime Repository:** [github.com/Robinlovelace/carscrime](https://github.com/Robinlovelace/carscrime)
